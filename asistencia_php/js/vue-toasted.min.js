      ...
      var s = function t(e) {
        ...
        c = function (t, e, i) {
          ...
          if ("object" !== (void 0 === i ? "undefined" : o(i)))
            return (
              console.error("Options should be a type of object. given : " + i),
              null
            );
          t.options.singleton &&
            t.toasts.length > 0 &&
            ((t.cached_options = i), t.toasts[t.toasts.length - 1].goAway(0));
          var s = Object.assign({}, t.options);
          return (
            Object.assign(s, i), (a = n.i(r.a)(t, e, s)), t.toasts.push(a), a
          );
        },
        u = function (t) {
    ...
    function (t, e, n) {
      (function (n) {
        ...
        !(function (n, a) {
          ...
          function m(t, e) {
            return R.dom(t) && i(D, e)
              ? "transform"
              : R.dom(t) && (t.getAttribute(e) || (R.svg(t) && t[e]))
              ? "attribute"
              : R.dom(t) && "transform" !== e && h(t, e)
              ? "css"
              : null != t[e]
              ? "object"
              : void 0;
          ...
          function O(t, e) {
            ...
            return r(t)
              .map(function (t, n) {
                return (
                  (n = n ? 0 : e.delay),
                  (t = R.obj(t) && !R.pth(t) ? t : { value: t }),
                  R.und(t.delay) && (t.delay = n),
                  t
                );
              })
              .map(function (t) {
          ...
          function M(t, e) {
            ...
            return t.tweens.map(function (r) {
              ...
              return (
                ...
                (r.isPath = R.pth(i)),
                (r.isColor = R.col(r.from.original)),
                r.isColor && (r.round = 1),
                (n = r)
              );
            });
          ...
          function L(t) {
            ...
            for (e in t)
              s.hasOwnProperty(e) ||
                "targets" === e ||
                o.push({ name: e, offset: s.offset, tweens: O(t[e], r) });
            return (
              (t = k(i, o)),
              c(n, {
                children: [],
              ...
              for (var n = 0, r = {}, i = d.animations, o = i.length; n < o; ) {
                ...
                for (
                  var c =
                      ...
                      l.duration,
                    f = isNaN(c) ? 1 : l.easing(c, l.elasticity),
                    c = l.to.strings,
                    p = l.round,
                    u = [],
                    m = void 0,
                  ...
                  p && ((l.isColor && 2 < v) || (g = Math.round(g * p) / p)),
                    u.push(g);
                }
                if ((l = c.length))
                  for (m = c[0], f = 0; f < l; f++)
                    (p = c[f + 1]),
                      (v = u[f]),
                      isNaN(v) || (m = p ? m + (v + p) : m + (v + " "));
                else m = u[0];
                Y[a.type](s.target, a.property, m, r, s.id),
                  (a.currentValue = m),
                  n++;
              }
                ...
                for (i = 0; i < n; i++)
                  N ||
                    (N = h(document.body, "transform")
                      ? "transform"
                      : "-webkit-transform"),
                    (d.animatables[i].target.style[N] = r[i].join(" "));
            ...
            function s(t) {
              ...
              if (d.children.length) {
                var y = d.children,
                  b = y.length;
                if (g >= d.currentTime)
                  for (var x = 0; x < b; x++) y[x].seek(g);
                else for (; b--; ) y[b].seek(g);
              }
              (g >= h || !e) &&
          ...
          var N,
              ...
              return function (e, n, r, i) {
                if (0 <= e && 1 >= e && 0 <= r && 1 >= r) {
                  ...
                  return function (a) {
                    ...
                    if (0 === a) return 0;
                    if (1 === a) return 1;
                    for (var s = 0, c = 1; 10 !== c && o[c] <= a; ++c) s += 0.1;
                    --c;
                    var c = s + ((a - o[c]) / (o[c + 1] - o[c])) * 0.1,
                      u =
                        3 * (1 - 3 * r + 3 * e) * c * c +
                        2 * (3 * r - 6 * e) * c +
                        3 * e;
            ...
            z = (function () {
              ...
              var e,
                ...
                i = { linear: F(0.25, 0.25, 0.75, 0.75) },
                o = {};
              for (e in r)
                (o.type = e),
                  r[o.type].forEach(
            ...
            V = (function () {
              ...
              function e(e) {
                var n = H.length;
                if (n) {
                  for (var r = 0; r < n; ) H[r] && H[r].tick(e), r++;
                  t();
          ...
          return (
            ...
            (j.path = function (e, n) {
              var r = R.str(e) ? t(e)[0] : e,
                i = n || 100;
              return function (t) {
                return { el: r, property: t, totalLength: T(r) * (i / 100) };
              };
            }),
          ...
          return (
            setTimeout(function () {
              if (
                ...
                return void r.a.animateOutBottom(t, function () {
                  n.remove(t);
                });
      ...
      !(function (i, o, a, s) {
        ...
        function k(t, e) {
          ...
          (e.overallVelocityX = u.x),
            ...
            (e.scale = a ? z(a.pointers, r) : 1),
            (e.rotation = a ? F(a.pointers, r) : 0),
        ...
        function V(t, e) {
          ...
          return (
            e & (Pt | Lt) && (n = E(n.concat(r), "identifier", !0)), [n, r]
          );
        }
        function W() {
        ...
        function U(t, e) {
          ...
          for (i = 0; i < a.length; )
            r[a[i].identifier] && s.push(a[i]),
              e & (Pt | Lt) && delete r[a[i].identifier],
              i++;
        ...
        A.prototype = {
          ...
          destroy: function () {
            this.evEl && g(this.element, this.evEl, this.domHandler),
              ...
              this.evWin && g(O(this.element), this.evWin, this.domHandler);
          },
        };
        var qt = { mousedown: Mt, mousemove: kt, mouseup: Pt },
          Vt = "mousedown",
        ...
        var Ut = {
          ...
          Bt = { 2: "touch", 3: "pen", 4: "mouse", 5: "kinect" },
          $t = "pointerdown",
        ...
        (K.prototype = {
          ...
          requireFailure: function (t) {
            ...
            return (
              (t = nt(t, this)),
              -1 === T(e, t) && (e.push(t), t.requireFailure(this)),
              this
            );
          },
          ...
          recognize: function (t) {
            ...
            this.state & (me | ve | 32) && (this.state = fe),
          ...
          p(at, K, {
            ...
            process: function (t) {
              ...
              if (
                ((this._input = t), !r || !n || (t.eventType & (Pt | Lt) && !i))
              )
                this.reset();
            ...
            process: function (t) {
              ...
              if (r && i && n) {
                ...
                var o = !this.pTime || t.timeStamp - this.pTime < e.interval,
                  a =
                    !this.pCenter || D(this.pCenter, t.center) < e.posThreshold;
              ...
              for (var o = 0; o < r.length; )
                (n = r[o]),
                  2 === e.stopped || (i && n != i && !n.canRecognizeWith(i))
                    ? n.reset()
                    : n.recognize(t),
                  !i && n.state & (pe | de | he) && (i = e.curRecognizer = n),
                  o++;
            }
          },
          get: function (t) {
